...
export const CameraFlipIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M14.53 3.47a1 1 0 0 0-1.06 0l-3 3a1 1 0 0 0 1.41 1.41l1.15-1.14V10a1 1 0 1 0 2 0V6.74l1.15 1.14a1 1 0 0 0 1.41-1.41l-3-3zM9.47 20.53a1 1 0 0 0 1.06 0l3-3a1 1 0 0 0-1.41-1.41l-1.15 1.14V14a1 1 0 1 0-2 0v3.26l-1.15-1.14a1 1 0 0 0-1.41 1.41l3 3z"/>
    <path d="M22 11h-1a2 2 0 0 0-2-2V7a2 2 0 0 0-2-2h-3"/>
    <path d="M2 13h1a2 2 0 0 0 2 2v2a2 2 0 0 0 2 2h3"/>
  </svg>
);
